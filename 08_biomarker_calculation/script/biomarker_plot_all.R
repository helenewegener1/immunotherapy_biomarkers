...
df_plot_DEAssGSEA <- readRDS('08_biomarker_calculation/out/02_DEAssGSEA_df_plot.rds') 
...
for (this_cancer in cancer_types){
  ...
  if (n_var2 > 1){
    ...
    # Export plots in one figure
    wrap_plots(plots) 
    ggsave(glue('08_biomarker_calculation/plot/TGEP_{this_cancer}_{var2}_{var1}.png'), width = 13, height = 9)

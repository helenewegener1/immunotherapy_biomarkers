...
for dataset in datasets:
    ...
    ioutil.load_samples(# The CSV file where the samples are stored
                        csv_file = '/Users/srz223/Documents/projects/project_DGD/immunotherapy_biomarkers/03_prepDGD/out/' + dataset + '_counts_dgd_input.csv',
    ...
    ioutil.save_samples(\
        ...
        df = df_preproc,
        # The output CSV file
        csv_file = "../out/" + dataset + "_preprocessed.csv",
    ...
    ioutil.save_representations(\
        ...
        df = df_rep,
        # The output CSV file
        csv_file = "../out/" + dataset + "_representations.csv",
        # The field separator in the output CSV file
        sep = ",")
    ...
    ioutil.save_representations(\
        ...
        df = df_pred_r_values,
        # The output CSV file
        csv_file = "../out/" + dataset + "_pred_r_values.csv",
        # The field separator in the output CSV file
        sep = ",")
    ...
    ioutil.save_decoder_outputs(\
        ...
        df = df_dec_out,
        # The output CSV file
        csv_file = "../out/" + dataset + "_decoder_outputs.csv",
        # The field separator in the output CSV file
        sep = ",")
    ...
    ioutil.save_time(\
        ...
        df = df_time_opt,
        # The output CSV file
        csv_file = "../out/" + dataset + "_time_opt.csv",
        # The field separator in the output CSV file
        sep = ",")
    ...
    ioutil.save_samples(\
        ...
        df = df_prob_rep,
        # The output CSV file
        csv_file = "../out/" + dataset + "_prob_rep.csv",
        # The field separator in the output CSV file
        sep = ",")
    ...
    ioutil.save_samples(\
        ...
        df = df_prob_comp,
        # The output CSV file
        csv_file = "../out/" + dataset + "_prob_comp.csv",
        # The field separator in the output CSV file
        sep = ",")
